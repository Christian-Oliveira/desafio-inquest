...
URL_ASSET_DETAIL = "assests:asset-detail"
...
class TestGetAssets(TestCase):
    ...
    def test_get_all_assets_to_person_with_id(self):
        response = self.client.get(reverse(URL_ASSETS_LIST)+"?person_id="+str(self.person1.pk))
